...
class LoginPage {
    ...
    SucessfullLogIn() {
        cy.get(mainPageLocators.openLogInBtn).click()
        cy.fixture('users.json').then((users) => {
            ...
            cy.wait(1000)
            cy.get(mainPageLocators.logInBtn).eq(2).click()
            cy.get(mainPageLocators.welcomeBtn).should('have.text', 'Welcome' + ' ' + users.validUser.username)
    })}
